...
* Hämta den stora databasen från FIDE
  * http://ratings.fide.com/download/players_list.zip
  * Observera att https inte fungerar
  * Observera att filen förväntas heta **players_list_foa.txt**
...
* Kopiera katalogen shards till bl a 2025/035-FairPair
